...
class Config:
    ...
    STEPFUN_MODEL = os.environ.get("STEPFUN_MODEL", "step-1o-turbo-vision")
    ...
    RECOGNIZE_RATE_LIMIT_PER_ACCOUNT = _env_int("RECOGNIZE_RATE_LIMIT_PER_ACCOUNT", 30)
    RECOGNIZE_RATE_LIMIT_ACCOUNT_WINDOW_SECONDS = _env_int("RECOGNIZE_RATE_LIMIT_ACCOUNT_WINDOW_SECONDS", 3600)
    RECOGNIZE_RATE_LIMIT_PER_IP = _env_int("RECOGNIZE_RATE_LIMIT_PER_IP", 60)
    RECOGNIZE_RATE_LIMIT_IP_WINDOW_SECONDS = _env_int("RECOGNIZE_RATE_LIMIT_IP_WINDOW_SECONDS", 3600)
    RECOGNIZE_MAX_IMAGE_BYTES = _env_int("RECOGNIZE_MAX_IMAGE_BYTES", 8 * 1024 * 1024)
