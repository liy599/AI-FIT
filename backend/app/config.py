...
class Config:
    ...
    POSE_POLICY_PULLUP_SWING_WARN_RATIO = _env_float("POSE_POLICY_PULLUP_SWING_WARN_RATIO", 0.12)
    POSE_POLICY_PULLUP_SWING_FAIL_RATIO = _env_float("POSE_POLICY_PULLUP_SWING_FAIL_RATIO", 0.35)
    POSE_POLICY_PULLUP_RANGE_WARN_RATIO = _env_float("POSE_POLICY_PULLUP_RANGE_WARN_RATIO", 0.12)
    POSE_POLICY_PULLUP_RANGE_FAIL_RATIO = _env_float("POSE_POLICY_PULLUP_RANGE_FAIL_RATIO", 0.35)
