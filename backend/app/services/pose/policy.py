    ...
    return {
        ...
        "rules": {
            ...
            "analyzer": {
                ...
                "bent_over_row": {
                    "tracking_quality_min": _cfg_float("POSE_POLICY_BENT_OVER_ROW_TRACKING_QUALITY_MIN", 0.20, 0.05, 0.95),
                    "torso_lean_warn_deg": _cfg_int("POSE_POLICY_BENT_OVER_ROW_BACK_ANGLE_WARN_DEG", 60, 5, 90),
                    "torso_lean_fail_deg": _cfg_int("POSE_POLICY_BENT_OVER_ROW_BACK_ANGLE_FAIL_DEG", 75, 5, 110),
                    "knee_straight_warn_deg": _cfg_int("POSE_POLICY_BENT_OVER_ROW_KNEE_STRAIGHT_WARN_DEG", 160, 120, 180),
                    "knee_straight_fail_deg": _cfg_int("POSE_POLICY_BENT_OVER_ROW_KNEE_STRAIGHT_FAIL_DEG", 168, 120, 180),
                    "knee_straight_fail_min_frames": _cfg_int("POSE_POLICY_BENT_OVER_ROW_KNEE_STRAIGHT_FAIL_MIN_FRAMES", 2, 1, 30),
                    "symmetry_warn_deg": _cfg_int("POSE_POLICY_BENT_OVER_ROW_SYMMETRY_WARN_DEG", 25, 1, 80),
                    "symmetry_fail_deg": _cfg_int("POSE_POLICY_BENT_OVER_ROW_SYMMETRY_FAIL_DEG", 35, 1, 100),
                    "top_range_min_deg": _cfg_int("POSE_POLICY_BENT_OVER_ROW_TOP_RANGE_MIN_DEG", 44, 30, 160),
                },
            },
        },
    }
