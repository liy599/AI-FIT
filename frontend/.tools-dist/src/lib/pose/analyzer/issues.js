...
export function mapSuggestionFromIssue(issue, exerciseSlug) {
    ...
    if (text.includes('depth'))
        return 'Aim to descend until thighs are near parallel while keeping balance over mid-foot.';
    if (text.includes('heel') && text.includes('lift'))
        return 'Shift pressure to mid-foot/heel and widen stance slightly if needed.';
