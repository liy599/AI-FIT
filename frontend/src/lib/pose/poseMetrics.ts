...
export function midpointLandmark(a: NormalizedLandmark | undefined, b: NormalizedLandmark | undefined) {
...
export function angleFromVerticalDeg(top: NormalizedLandmark | undefined, bottom: NormalizedLandmark | undefined) {
