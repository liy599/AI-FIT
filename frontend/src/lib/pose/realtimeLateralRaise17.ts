...
export type LateralRaise17Tuning = {
...
export type LateralRaise17Tempo = {
  repFastSec: number
  repSlowSec: number
}

export const DEFAULT_LATERAL_RAISE17_TUNING: LateralRaise17Tuning = {
...
export const REALTIME_DEFAULT_LATERAL_RAISE17_TEMPO: LateralRaise17Tempo = {
  repFastSec: 0.9,
  repSlowSec: 2.6
}

export const VIDEO_DEFAULT_LATERAL_RAISE17_TEMPO: LateralRaise17Tempo = {
  repFastSec: 0.95,
  repSlowSec: 3.0
}
...
export class RealtimeLateralRaise17Analyzer {
  private repCount = 0
  ...
  private tuning: LateralRaise17Tuning = { ...DEFAULT_LATERAL_RAISE17_TUNING }
  private tempo: LateralRaise17Tempo = { ...REALTIME_DEFAULT_LATERAL_RAISE17_TEMPO }
  private smoothLeftRaise: number | null = null
  private smoothRightRaise: number | null = null

  setTuning(next: Partial<LateralRaise17Tuning>) {
    this.tuning = {
      ...this.tuning,
      ...next
    }
  ...
  setTempo(next: Partial<LateralRaise17Tempo>) {
    const repFastSec =
